...
"1:\n" // label_init_session
        ...
        "jz 2f\n" // label_load_h
        "mov BIAS_PTR_IDX(%[param]), %%rdx\n"
        ".if U_S > 0\n"
        "vmovups (0 * OC_REG_ELTS * D_BYTES)(%%rdx), %%ymm0\n"
        "vmovups (1 * OC_REG_ELTS * D_BYTES)(%%rdx), %%ymm1\n"
        ".endif\n"
        ".if U_S > 1\n"
        "vmovaps %%ymm0, %%ymm2\n"
        "vmovaps %%ymm1, %%ymm3\n"
...
"2:\n" // label_load_h
        ...
        "jz 4f\n" // label_compute_session
        "mov BIAS_PTR_IDX(%[param]), %%rdx\n"
        "vmovups (0 * OC_REG_ELTS * D_BYTES)(%%rdx), %%ymm14\n"
        "vmovups (1 * OC_REG_ELTS * D_BYTES)(%%rdx), %%ymm15\n"
        ".if U_S > 0\n"
...
"8:\n" // label_relu_end
        ...
        ".if NT_STORE\n"
        ".if U_S > 0\n"
        "vmovntps %%ymm0, (((0 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovntps %%ymm1, (((0 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 1\n"
        "vmovntps %%ymm2, (((1 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovntps %%ymm3, (((1 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 2\n"
        "vmovntps %%ymm4, (((2 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovntps %%ymm5, (((2 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 3\n"
        "vmovntps %%ymm6, (((3 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovntps %%ymm7, (((3 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 4\n"
        "vmovntps %%ymm8, (((4 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovntps %%ymm9, (((4 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 5\n"
        "vmovntps %%ymm10, (((5 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovntps %%ymm11, (((5 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".else\n"
        ".if U_S > 0\n"
        "vmovups %%ymm0, (((0 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovups %%ymm1, (((0 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 1\n"
        "vmovups %%ymm2, (((1 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovups %%ymm3, (((1 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 2\n"
        "vmovups %%ymm4, (((2 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovups %%ymm5, (((2 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 3\n"
        "vmovups %%ymm6, (((3 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovups %%ymm7, (((3 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 4\n"
        "vmovups %%ymm8, (((4 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovups %%ymm9, (((4 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".if U_S > 5\n"
        "vmovups %%ymm10, (((5 - U_S) * OC_DATA_BLK + 0 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        "vmovups %%ymm11, (((5 - U_S) * OC_DATA_BLK + 1 * OC_REG_ELTS) * D_BYTES)(%%r14)\n"
        ".endif\n"
        ".endif\n"
        "sub $U_S, %%r15\n"
